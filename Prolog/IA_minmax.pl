...
transition(jeu(Deck,Passetour,Positions,faux,Listetas,12,Ordre,_),jeu(Nouvdeck,Passetour,Resultatction,faux,_,1,Nouvordre,_),estletourde(Nomcoureur,Ordre,Valtour,_),depassement(Nomcoureur,Positions, Valeurcarteseconde,Nouvposition)):-
...
transition(jeu(Deck,Passetour,Positions,faux,Listetas,Valtour,Ordre),jeu(Nouvdeck,Passetour,Resultatction,faux,NouvListetas,Nouvvaltour,Ordre),estletourde(Nomcoureur,Ordre,Valtour,_),depassement(Nomcoureur,Positions, Valeurcarteseconde,Nouvposition)):-
...
transition(jeu(Deck,Passetour,Positions,faux,,Listetas,12,Ordre),jeu(Nouvdeck,Passetour,Resultatction,faux,NouvListetas,1,Nouvvaltour,Nouvordre),estletourde(Nomcoureur,Ordre,Valtour,_),depassement(Nomcoureur,Positions, Valeurcarteseconde,Nouvposition)):-
  not(member(Nomcoureur,Passetour)),peutdepasser(Nomcoureur,Positions,Listetas,Valeurcarteseconde,NouvPos),casechance(NouvPos),random_between(-3, 3, Valmouvement),traitementcasechance(Idcase,Valeurmouvement, Idnouvellecase),miseajourpositioncoureur(Nomcoureur,Idnouvellecase,Positions,Resultatction),coureurs(Coureurs),not(chute(Coureurs,Idnouvellecase)),
...
%Pas dans Passetour,Position dans tour < 12, arrivée sur un case chance , pas de chute, personne n'a passé la ligne d'arrivée et avec l'action le coureur dont c'est le tour ne l'a pas non plus passée
transition(jeu(Deck,Passetour,Positions,faux,_,_),jeu(Nouvdeck,Passetour,Resultatction,vrai,_,_),estletourde(Nomcoureur,Ordre,Valtour,_),depassement(Nomcoureur,Positions, Valeurcarteseconde,Nouvposition)):-
