...
transition(jeu(Deck,Passetour,Positions,Faux,Listetas,12,Ordre),jeu(Nouvdeck,Passetour,Resultatction,Faux,_,1,Nouvordre),estletourde(Nomcoureur,Ordre,Valtour,_),depassement(Nomcoureur,Positions, Valeurcarteseconde,Nouvposition)):-
